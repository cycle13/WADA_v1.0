...
Function:
    ...
    For dMSE/dt.
    This file has been modified to calculate dMSE/dt over the equatorial Andes,
    rather than the Andean East flank, like the 12_c_dMSEdt_Height_time.py did.
"""
import numpy as np
...
/Vertical_growth_of_temperature_anomaly/CloudForcing_SurfaceFluxes/'
files = 'MSE_avg_Andes_box_hourly_96hrs.nc'
...
#cset2 = axes[2].contourf(X, Y, np.transpose(Vars[2,:,:]), cmap='bwr',
#                         levels=np.linspace(-0.38,0.38,11))
...
plt.show()
#plt.savefig('../Figures/12_c_dMSEdt_Height_time_Andes_96hr.pdf')
#plt.savefig('../Figures/12_c_dMSEdt_Height_time_Andes_96hr.png')
