...
/Vertical_growth_of_temperature_anomaly/CloudForcing_SurfaceFluxes/'
files = 'CLOUD_avg_box_hourly_96hrs_Andes.nc'
...
#plt.show()
plt.savefig('../Figures/11_b_CLOUD_Height_time_96hr_Andes.pdf')
plt.savefig('../Figures/11_b_CLOUD_Height_time_96hr_Andes.png')
